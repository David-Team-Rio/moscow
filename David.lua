...
--     Source David     --
if text == "ردود المطور" and RioSudo(msg) or text == "الردود العام" and RioSudo(msg) or text == "ردود العام" and RioSudo(msg) or text == "↫ الردود العام ↯" and RioSudo(msg) then
