...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1558668590,1637019058}
David = Config.David
...
if text == "حذف الاوامر المضافه" and SourceCh(msg) or text == "حذف الاوامر" and SourceCh(msg) or text == "مسح الاوامر المضافه" and ChCheck(msg) and SourceCh(msg) then
local List = DevRio:smembers(David.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
...
if text == "اضف امر" and SourceCh(msg) or text == "اضافة امر" and SourceCh(msg) or text == "اضافه امر" and ChCheck(msg) and SourceCh(msg) then
...
if text == "حذف امر" and SourceCh(msg) or text == "مسح امر" and ChCheck(msg) and SourceCh(msg) then 
...
--     Source David     --
if text == "الصلاحيات" and SourceCh(msg) or text == "صلاحيات" and ChCheck(msg) and SourceCh(msg) then 
...
if SecondSudo(msg) then
if text == 'تعيين رد الخاص' and SourceCh(msg) or text == 'ضع كليشه ستارت' and SourceCh(msg) or text == '↫ تعيين رد الخاص ↯' and SourceCh(msg) then 
DevRio:set(David..'Rio:Start:Bots'..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙ارسل لي كليشة الستارت الان', 1, 'md')
return false
end
if text == 'حذف رد الخاص' and SourceCh(msg) or text == 'حذف كليشه ستارت' and SourceCh(msg) or text == '↫ حذف رد الخاص ↯' and SourceCh(msg) then 
DevRio:del(David..'Start:Bot') 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف كليشة الستارت بنجاح', 1, 'md')
end
if text == 'جلب رد الخاص' and SourceCh(msg) or text == '↫ جلب رد الخاص ↯' and SourceCh(msg) then  
local start = DevRio:get(David.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
if text == 'تفعيل التواصل' and SourceCh(msg) or text == '↫ تفعيل التواصل ↯' and SourceCh(msg) then   
...
if text == 'تعطيل التواصل' and SourceCh(msg) or text == '↫ تعطيل التواصل ↯' and SourceCh(msg) then  
...
--     Source David     --
if SecondSudo(msg) then
if text == 'جلب نسخه الكروبات' and SourceCh(msg) or text == 'جلب نسخه احتياطيه' and SourceCh(msg) or text == 'جلب النسخه الاحتياطيه' and SourceCh(msg) or text == '↫ جلب نسخه احتياطيه ↯' and SourceCh(msg) then
...
--     Source David     --
if text == "الرابط" and SourceCh(msg) then
...
if text ==  'حذف رسائلي' and SourceCh(msg) or text ==  'مسح رسائلي' and SourceCh(msg) then DevRio:del(David..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and SourceCh(msg) or text ==  'مسح نقاطي' and SourceCh(msg) then DevRio:del(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع نقاطك', 1, 'md') end
--     Source David     --
...
if text == 'محيبس' and SourceCh(msg) or text == 'بات' and SourceCh(msg) or text == 'المحيبس' and ChCheck(msg) and SourceCh(msg) then
if not DevRio:get(David..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
...
--     Source David     --
if text == 'روليت' and SourceCh(msg) then
if not DevRio:get(David..'Rio:Lock:Games'..msg.chat_id_) then
...
--     Source David     --
if text == 'كت تويت' and SourceCh(msg) or text == 'كت' and SourceCh(msg) or text == 'تويت' and SourceCh(msg) then
if not DevRio:get(David..'Rio:Lock:Games'..msg.chat_id_) then
local DavidTeam = {
...
--     Source David     --
if text == 'الالعاب' and SourceCh(msg) or text == 'العاب' and SourceCh(msg) or text == 'اللعبه' and SourceCh(msg) then
if not DevRio:get(David..'Rio:Lock:Games'..msg.chat_id_) then
...
--     Source David     --
if text == 'بيع نقاطي' and SourceCh(msg) then
if tonumber((DevRio:get(David..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙لم تربح اي نقطه\n↯︙ارسل ↫ الالعاب للعب', 1, 'md')
else
...
--     Source David     --
if text == 'غادر' and SudoBot(msg) and SourceCh(msg) then
...
--     Source David     --
if text == "تعيين قناة الاشتراك" and SourceCh(msg) or text == "تغيير قناة الاشتراك" and SourceCh(msg) or text == "تعيين الاشتراك الاجباري" and SourceCh(msg) or text == "وضع قناة الاشتراك" and SourceCh(msg) or text == "↫ تعيين قناة الاشتراك ↯" and SourceCh(msg) then
...
if text == "تفعيل الاشتراك الاجباري" and SourceCh(msg) or text == "↫  تفعيل الاشتراك الاجباري ↯" and SourceCh(msg) then  
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
if DevRio:get(David..'Rio:ChId') then
...
if text == "تعطيل الاشتراك الاجباري" and SourceCh(msg) or text == "↫  تعطيل الاشتراك الاجباري ↯" and SourceCh(msg) then  
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
...
if text == "حذف قناة الاشتراك" and SourceCh(msg) or text == "حذف قناه الاشتراك" and SourceCh(msg) or text == "↫ حذف قناة الاشتراك ↯" and SourceCh(msg) then
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
DevRio:del(David..'Rio:ChId')
...
if SecondSudo(msg) then
if text == 'جلب قناة الاشتراك' and SourceCh(msg) or text == 'قناة الاشتراك' and SourceCh(msg) or text == 'الاشتراك الاجباري' and SourceCh(msg) or text == 'قناة الاشتراك الاجباري' and SourceCh(msg) or text == '↫ قناة الاشتراك ↯' and SourceCh(msg) then
if DevRio:get(David..'Rio:ChId') then
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(David.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
--     Source David     --
if text and (text == 'تفعيل التاك' or text == 'تفعيل التاك للكل' or text == 'تفعيل تاك للكل') and Admin(msg) and ChCheck(msg) and SourceCh(msg) then 
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امر تاك للكل'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David..'Rio:Lock:TagAll'..msg.chat_id_)
end
if text and (text == 'تعطيل التاك' or text == 'تعطيل التاك للكل' or text == 'تعطيل تاك للكل') and Admin(msg) and ChCheck(msg) and SourceCh(msg) then 
...
--     Source David     --
if text == "تعطيل تفاعلي" and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
...
--     Source David     --
if text == "اهمس" and SourceCh(msg) or text == "همسه" and SourceCh(msg) or text == "اريد بوت الهمسه" and SourceCh(msg) or text == "دزلي بوت الهمسه" and SourceCh(msg) or text == "دزولي بوت الهمسه" and SourceCh(msg) then  Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙@HMSEBOT', 1, 'md') end
if text == "رابط حذف" and SourceCh(msg) or text == "رابط الحذف" and SourceCh(msg) or text == "اريد رابط الحذف" and SourceCh(msg) or text == "شمرلي رابط الحذف" and SourceCh(msg) or text == "اريد رابط حذف" and SourceCh(msg) then local inline = {{{text="اضغط هنا",url="https://t.me/DYFBOT"}}} SendInline(msg.chat_id_,'↯︙اضغط للحصول على الرابط',nil,inline) return false end
if text == "بوت الحذف" and SourceCh(msg) or text == "اريد بوت الحذف" and SourceCh(msg) or text == "اريد بوت حذف" and SourceCh(msg) or text == "بوت حذف" and SourceCh(msg) or text == "بوت حذف حسابات" and SourceCh(msg) or text == "راح احذف" and SourceCh(msg) then local inline = {{{text="اضغط هنا",url="https://t.me/DYFBOT"}}} SendInline(msg.chat_id_,'↯︙اضغط للحصول على البوت',nil,inline) return false end
...
--     Source David     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) and SourceCh(msg) or text and text:match('^هينها @(.*)') and SourceCh(msg) then 
...
if text == 'لقبه' and SourceCh(msg) then
...
if text == 'لقبي' and SourceCh(msg) then
if GetCustomTitle(msg.sender_user_id_,msg.chat_id_) == false then
...
if text == 'نبذتي' and SourceCh(msg) or text == 'بايو' and SourceCh(msg) then
send(msg.chat_id_, msg.id_,'['..GetBio(msg.sender_user_id_)..']')
end
if text == "راسلني" and SourceCh(msg) then
...
--         BanAll         --
if SecondSudo(msg) then
if text ==('حضر عام') or text ==('حظر عام') and SourceCh(msg) then
...
if text and (text:match('^حضر عام @(.*)') or text:match('^حظر عام @(.*)')) and SourceCh(msg) then
...
if text and (text:match('^حضر عام (%d+)') or text:match('^حظر عام (%d+)')) and SourceCh(msg) then
...
--     Source David     --
--         MuteAll        --
if text ==('كتم عام') and SourceCh(msg) then
...
if text and text:match('^كتم عام @(.*)') and SourceCh(msg) then
...
if text and text:match('^كتم عام (%d+)') and SourceCh(msg) then
...
--     Source David     --
--         UnAll          --
if text ==('الغاء عام') or text ==('الغاء العام') and SourceCh(msg) then
...
if text and (text:match('^الغاء عام @(.*)') or text:match('^الغاء العام @(.*)')) and SourceCh(msg) then
...
if text and (text:match('^الغاء عام (%d+)') or text:match('^الغاء العام (%d+)')) and SourceCh(msg) then
...
--     Source David     --
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي" or text == "↫ تغير المطور الاساسي ↯") and msg.reply_to_message_id_ == 0 and Sudo(msg) and SourceCh(msg) then 
...
--     Source David     --
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and SourceCh(msg) then  
if Constructor(msg) then
...
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ == 0 and SourceCh(msg) then  
if Constructor(msg) then
...
--     Source David     --
if Admin(msg) then
if text == "المكتومين" and SourceCh(msg) then 
...
--     Source David     --
if text == "المحظورين" and SourceCh(msg) or text == "المحضورين" and SourceCh(msg) then 
...
--     Source David     --
if text == "المطورين الاساسيين" and SourceCh(msg) and RioSudo(msg) or text == "الاساسيين" and RioSudo(msg) and SourceCh(msg) or text == "↫ الاساسيين ↯" and RioSudo(msg) and SourceCh(msg) then 
...
--     Source David     --
if text == "المطورين الثانويين" and SecondSudo(msg) and SourceCh(msg) or text == "الثانويين" and SecondSudo(msg) and SourceCh(msg) or text == "↫ الثانويين ↯" and SecoundSudo(msg) and SourceCh(msg) then 
...
--     Source David     --
if SudoBot(msg) then
if text == "قائمه العام" and ChCheck(msg) and SourceCh(msg) or text == "المحظورين عام" and ChCheck(msg) and SourceCh(msg) or text == "المكتومين عام" and ChCheck(msg) and SourceCh(msg) or text == "↫ قائمه العام ↯" and ChCheck(msg) and SourceCh(msg) or text == "↫ قائمه العام ↯" and ChCheck(msg) and SourceCh(msg) then 
...
if text and text:match("^حذف الايدي العام$") or text and text:match("^مسح الايدي العام$") or text and text:match("^حذف كليشة الايدي$") and SourceCh(msg) then
...
--     Source David     --
if text == 'ضع رابط' and SourceCh(msg) or text == 'وضع رابط' and SourceCh(msg) or text == 'ضع الرابط' and SourceCh(msg) or text == 'وضع الرابط' and SourceCh(msg) then
...
if text == 'انشاء رابط' and SourceCh(msg) or text == 'انشاء الرابط' and SourceCh(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
...
--     Source David     --
if SudoBot(msg) then
if text and text == "الاحصائيات" and ChCheck(msg) and SourceCh(msg) or text and text == "↫  الاحصائيات ↯" and SourceCh(msg) then
...
if text and text == "المشتركين" and ChCheck(msg) and SourceCh(msg) or text and text == "↫ المشتركين ↯" and SourceCh(msg) then
local users = DevRio:scard(David.."Rio:Users")
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙عدد المشتركين ↫ ❨ '..users..' ❩', 1, 'md')
end
if text and text == "المجموعات" and ChCheck(msg) and SourceCh(msg) or text and text == "↫ المجموعات ↯" and SourceCh(msg) then
...
if text == "تنظيف المشتركين" and SecondSudo(msg) and ChCheck(msg) and SourceCh(msg) or text == "↫ تنظيف المشتركين ↯" and SecondSudo(msg) and ChCheck(msg) and SourceCh(msg) then 
...
--     Source David     --
if text == "تنظيف الكروبات" and SecondSudo(msg) and ChCheck(msg) and SourceCh(msg) or text == "تنظيف المجموعات" and SecondSudo(msg) and ChCheck(msg) and SourceCh(msg) or text == "↫ تنظيف المجموعات ↯" and SecondSudo(msg) and ChCheck(msg) and SourceCh(msg) then 
...
if text and (text:match("^تعين عدد المسح (%d+)$") or text:match("^تعيين عدد المسح (%d+)$") or text:match("^تعين عدد الحذف (%d+)$") or text:match("^تعيين عدد الحذف (%d+)$")) and Constructor(msg) and SourceCh(msg) then   
...
--     Source David     --
if Admin(msg) then
if text == "تنظيف تعديل" and ChCheck(msg) and SourceCh(msg) or text == "تنظيف التعديل" and ChCheck(msg) and SourceCh(msg) then   
Rio_Del = {[0]= msg.id_}
local Message = msg.id_
for i=1,100 do
Message = Message - 1048576
...
--     Source David     --
if Manager(msg) then
if text == "فحص" and SourceCh(msg) or text == "فحص البوت" and SourceCh(msg) then
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..David)
local GetInfo = JSON.decode(Check)
if GetInfo.ok == true then
if GetInfo.result.can_change_info == true then EDT = '✔️' else EDT = '✖️' end
...
if text and text:match("^تغير رد المطور (.*)$") and SourceCh(msg) then
local Text = text:match("^تغير رد المطور (.*)$") 
DevRio:set(David.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم تغير رد المطور الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد منشئ الاساسي (.*)$") and SourceCh(msg) then
...
if text and text:match("^تغير رد المنشئ (.*)$") and SourceCh(msg) then
...
--     Source David     --
if Admin(msg) then
if text and text:match("^حذف (.*)$") or text and text:match("^مسح (.*)$") and SourceCh(msg) then
...
--     Source David     --
if text and text:match("^كول (.*)$") and SourceCh(msg) then
local txt = {string.match(text, "^(كول) (.*)$")}
Dev_Rio(msg.chat_id_,0, 1, txt[2], 1, 'md')
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if text == "تفعيل انطق" and Manager(msg) and SourceCh(msg) then
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and SourceCh(msg) then
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(David..'Rio:Antk:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and text:match("^القوانين$") and SourceCh(msg) then
...
if text == "متحركه" and not DevRio:get(David..'Rio:gif:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "ميمز" and not DevRio:get(David..'Rio:memz:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "غنيلي" and not DevRio:get(David..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "اغنيه" and not DevRio:get(David..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) or text == "اغاني" and not DevRio:get(David..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "ريمكس" and not DevRio:get(David..'Rio:Remix:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "صوره" and not DevRio:get(David..'Rio:Photo:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "انمي" and not DevRio:get(David..'Rio:Anime:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "فلم" and not DevRio:get(David..'Rio:Movies:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text == "مسلسل" and not DevRio:get(David..'Rio:Series:Rio'..msg.chat_id_) and SourceCh(msg) then
...
--     Source David     --
if SecondSudo(msg) then
if text == 'تفعيل المغادره' or text == '↫ تفعيل المغادره ↯' and SourceCh(msg) then 
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل المغادره بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David.."Rio:Left:Bot"..David)
end
if text == 'تعطيل المغادره' or text == '↫ تعطيل المغادره ↯' and SourceCh(msg) then 
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل المغادره بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David.."Rio:Left:Bot"..David,true) 
end 
if text == 'تفعيل الاذاعه' or text == '↫ تفعيل الاذاعه ↯' and SourceCh(msg) then 
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الاذاعه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David.."Rio:Send:Bot"..David)
end
if text == 'تعطيل الاذاعه' or text == '↫ تعطيل الاذاعه ↯' and SourceCh(msg) then 
...
--     Source David     --
if text and text:match("^الغاء تثبيت الكل$") and SourceCh(msg) then  
if DevRio:sismember(David.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
Dev_Rio(msg.chat_id_,msg.id_, 1, "↯︙التثبيت والغاء واعادة التثبيت تم قفله من قبل المنشئين الاساسيين", 1, 'md')
return false  
end
...
--     Source David     --
if text == 'طرد المحذوفين' and SourceCh(msg) or text == 'مسح المحذوفين' and SourceCh(msg) or text == 'طرد الحسابات المحذوفه' and SourceCh(msg) or text == 'حذف المحذوفين' and SourceCh(msg) then  
...
--     Source David     --
if text and text:match("^مسح المحظورين$") or text and text:match("^حذف المحظورين$") and ChCheck(msg) or text and text:match("^مسح المطرودين$") or text and text:match("^حذف المطرودين$") and ChCheck(msg) and SourceCh(msg) then
...
--     Source David     --
if text and text:match("^معلومات المجموعه$") and ChCheck(msg) and SourceCh(msg) or text and text:match("^عدد الاعضاء$") and ChCheck(msg) and SourceCh(msg) or text and text:match("^عدد الكروب$") and ChCheck(msg) or text and text:match("^عدد الادمنيه$") and ChCheck(msg) and SourceCh(msg) or text and text:match("^عدد المحظورين$") and ChCheck(msg) and SourceCh(msg) then
...
--     Source David     --
if text and text:match('^كشف (-%d+)') and SourceCh(msg) then
...
--     Source David     --
if text and text:match("^غادر (-%d+)$") and SourceCh(msg) then
...
--     Source David     --
if text == 'تفعيل البوت الخدمي' and SourceCh(msg) or text == '↫ تفعيل البوت الخدمي ↯' and SourceCh(msg) then 
...
if text == 'تعطيل البوت الخدمي' and SourceCh(msg) or text == '↫ تعطيل البوت الخدمي ↯' and SourceCh(msg) then 
if not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط', 1, 'md')
else 
...
if ChatType == 'sp' or ChatType == 'gp'  then
if text == 'تفعيل الالعاب' and Manager(msg) and SourceCh(msg) or text == 'تفعيل اللعبه' and Manager(msg) and SourceCh(msg) then   
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(David..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then  
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" and SourceCh(msg) or text == "تفعيل جلب الرابط" and SourceCh(msg) then 
if Admin(msg) then
...
if text == "تعطيل الرابط" and SourceCh(msg) or text == "تعطيل جلب الرابط" and SourceCh(msg) then 
if Admin(msg) then
...
--     Source David     --
if text == "اذاعه خاص" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) or text == "↫ اذاعه خاص ↯" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) then 
if DevRio:get(David.."Rio:Send:Bot"..David) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source David     --
if text == "اذاعه" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) or text == "↫ اذاعه عام ↯" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) then 
if DevRio:get(David.."Rio:Send:Bot"..David) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source David     --
if text == "اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) or text == "↫ اذاعه عام بالتوجيه ↯" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) then 
if DevRio:get(David.."Rio:Send:Bot"..David) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source David     --
if text == "اذاعه خاص بالتوجيه" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) or text == "↫ اذاعه خاص بالتوجيه ↯" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) then 
if DevRio:get(David.."Rio:Send:Bot"..David) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source David     --
if text == "اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) or text == "↫ اذاعه بالتثبيت ↯" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and SourceCh(msg) then 
if DevRio:get(David.."Rio:Send:Bot"..David) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source David     --
if text == 'حذف رد من متعدد' and Manager(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح رد من متعدد' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
...
if text == 'حذف رد متعدد' and Manager(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح رد متعدد' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
local List = DevRio:smembers(David..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
...
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
...
--     Source David     --
if text == 'حذف رد عام' and SecondSudo(msg) and SourceCh(msg) or text == '↫ حذف رد عام ↯' and SecondSudo(msg) and SourceCh(msg) or text == 'مسح رد عام' and SecondSudo(msg) and SourceCh(msg) then
...
if text == 'اضف رد عام' and SecondSudo(msg) and SourceCh(msg) or text == '↫ اضف رد عام ↯' and SecondSudo(msg) and SourceCh(msg) then
...
--     Source David     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
...
if text == 'حذف الردود المتعدده' and Manager(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح الردود المتعدده' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
local redod = DevRio:smembers(David..'Rio:Manager:GpRedod'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود متعدده مضافه" ,  1, "md")
else
...
if text == 'حذف الردود' and Sudo(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح الردود' and Sudo(msg) and ChCheck(msg) and SourceCh(msg) or text == 'حذف ردود المدير' and Sudo(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح ردود المدير' and Sudo(msg) and ChCheck(msg) and SourceCh(msg) then
local redod = DevRio:smembers(David..'Rio:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
else
...
--     Source David     --
if  text == "ردود المطور" and Sudo(msg) and SourceCh(msg) or text == "الردود العام" and Sudo(msg) and SourceCh(msg) or text == "↫ ردود العام ↯" and Sudo(msg) and SourceCh(msg) or text == "↫ الردود العام ↯" and Sudo(msg) and SourceCh(msg) then
...
if text == "حذف ردود المطور" and Sudo(msg) and SourceCh(msg) or text == "حذف ردود العام" and Sudo(msg) and SourceCh(msg) or text == "مسح ردود المطور" and Sudo(msg) and SourceCh(msg) or text == "↫ مسح ردود العام ↯" and Sudo(msg) and SourceCh(msg) then
local redod = DevRio:smembers(David.."Rio:Sudo:AllRed")
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
else
...
--     Source David     --
if text and text == "تغيير اسم البوت" and SourceCh(msg) or text and text == "وضع اسم البوت" and SourceCh(msg) or text and text == "تغير اسم البوت" and SourceCh(msg) then
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
...
if text and text == 'حذف اسم البوت' and SourceCh(msg) or text == 'مسح اسم البوت' and SourceCh(msg) then
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
...
--     Source David     --
if text and text:match("^استعاده الاوامر$") and SecondSudo(msg) and SourceCh(msg) or text and text:match("^استعادة كلايش الاوامر$") and SecondSudo(msg) and SourceCh(msg) then
...
if text == "تعيين الاوامر" and SecondSudo(msg) and SourceCh(msg) or text == "تعيين امر الاوامر" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "الاوامر" and SourceCh(msg) or text == "اوامر" and SourceCh(msg) or text == "مساعده" and SourceCh(msg) then
local Help = DevRio:get(David..'Rio:Help')
local Text = [[
↯︙اهلا بك في قائمة الاوامر ↫ ⤈ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text == "تعيين امر م1" and SecondSudo(msg) and SourceCh(msg) or text == "تعيين امر م١" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "تعيين امر م2" and SecondSudo(msg) and SourceCh(msg) or text == "تعيين امر م٢" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "م2" and SourceCh(msg) or text == "م٢" and SourceCh(msg) or text == "اوامر2" and SourceCh(msg) or text == "اوامر٢" and SourceCh(msg) then
if not Admin(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙هذا الامر يخص الرتب الاعلى فقط\n↯︙ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
local Help = DevRio:get(David..'Rio:Help2')
...
if text == "تعيين امر م3" and SecondSudo(msg) and SourceCh(msg) or text == "تعيين امر م٣" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "م3" and SourceCh(msg) or text == "م٣" and SourceCh(msg) or text == "اوامر3" and SourceCh(msg) or text == "اوامر٣" and SourceCh(msg) then
if not Admin(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙هذا الامر يخص الرتب الاعلى فقط\n↯︙ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
local Help = DevRio:get(David..'Rio:Help3')
...
if text == "تعيين امر م4" and SourceCh(msg) and SecondSudo(msg) or text == "تعيين امر م٤" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "م٤" and SourceCh(msg) or text == "م4" and SourceCh(msg) or text == "اوامر4" and SourceCh(msg) or text == "اوامر٤" and SourceCh(msg) then
if not Admin(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙هذا الامر يخص الرتب الاعلى فقط\n↯︙ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
local Help = DevRio:get(David..'Rio:Help4')
...
if text == "تعيين امر م5" and SecondSudo(msg) and SourceCh(msg) or text == "تعيين امر م٥" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "م٥" and SourceCh(msg) or text == "م5" and SourceCh(msg) or text == "اوامر5" and SourceCh(msg) or text == "اوامر٥" and SourceCh(msg) then
if not SudoBot(msg) then
...
if text == "تعيين امر م6" and SecondSudo(msg) and SourceCh(msg) or text == "تعيين امر م٦" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "م٦" and SourceCh(msg) or text == "م6" and SourceCh(msg) or text == "اوامر6" and SourceCh(msg) or text == "اوامر٦" and SourceCh(msg) then
local Help = DevRio:get(David..'Rio:Help6')
local Text = [[
↯︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
os.execute('wget https://raw.githubusercontent.com/David-Team-Rio/moscow/master/David.lua') 
dofile('David.lua') 
...
--     Source David     --
if text == 'نقل الاحصائيات' and SourceCh(msg) or text == '↫ نقل الاحصائيات ↯' and SourceCh(msg) then
...
--     Source David     --
if text == 'الملفات' and SourceCh(msg) then
...
if text == "متجر الملفات" and SourceCh(msg) or text == 'المتجر' and SourceCh(msg) or text == '↫  المتجر ↯' and SourceCh(msg) then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and SourceCh(msg) then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and SourceCh(msg) then
...
--     Source David     --
if text and (text == 'حذف معلومات الترحيب' or text == 'مسح معلومات الترحيب') and SecondSudo(msg) and SourceCh(msg) then    
...
if text and (text == 'تفعيل ترحيب البوت' or text == 'تفعيل معلومات الترحيب' or text == '↫ تفعيل ترحيب البوت ↯') and SecondSudo(msg) and SourceCh(msg) then    
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم تفعيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
DevRio:del(David..'Rio:Lock:BotWelcome')
return false
end 
if text and (text == 'تعطيل ترحيب البوت' or text == 'تعطيل معلومات الترحيب' or text == '↫ تعطيل ترحيب البوت ↯') and SecondSudo(msg) and SourceCh(msg) then    
...
if text and (text == 'تغير معلومات الترحيب' or text == 'تغيير معلومات الترحيب' or text == '↫ تغير معلومات الترحيب ↯') and SecondSudo(msg) and SourceCh(msg) then    
...
--     Source David     --
if text and text:match("^ضع كليشه المطور$") or text and text:match("^وضع كليشه المطور$") or text and text:match("^تغيير كليشه المطور$") or text and text:match("^↫ تغيير كليشه المطور ↯$") and SourceCh(msg) then
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
...
if text and text:match("^↫ تغير كليشه الاشتراك ↯$") and SecondSudo(msg)  or text and text:match("^تغيير كليشه الاشتراك$") and SecondSudo(msg) and SourceCh(msg) then  
DevRio:setex(David.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
local text = '↯︙حسنا ارسل كليشة الاشتراك الجديده'  
Dev_Rio(msg.chat_id_, msg.id_, 1,text, 1, 'md') 
end
if text == "حذف كليشه الاشتراك الاجباري" and SourceCh(msg) or text == "↫ حذف كليشه الاشتراك ↯" and SourceCh(msg) then  
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
...
if text == 'كليشه الاشتراك' and SourceCh(msg) or text == 'جلب كليشه الاشتراك' and SourceCh(msg) or text == '↫ كليشه الاشتراك ↯' and SourceCh(msg) then
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
local chtext = DevRio:get(David.."Rio:ChText")
...
--     Source David     --
if RioSudo(msg) then 
if text == 'معلومات السيرفر' and SourceCh(msg) or text == 'السيرفر' or text == '↫ السيرفر ↯' and SourceCh(msg) then 
